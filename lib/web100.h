...
int                web100_get_connection_info(web100_agent *_agent, const struct web100_connection_info *_hints, struct web100_connection_info **_res);
void               web100_free_connection_info(struct web100_connection_info *_res);
